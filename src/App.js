...
// ── CONSTANTS ─────────────────────────────────────────────────────────────────
const YT_API_KEY = "AIzaSyBkvpczRM7qQTdSy63G5lxa93TFS1jrL7M";
...
const data = {
  ...
  gallery: [
    { id:1, url:"https://static.wixstatic.com/media/56d501_c0fdf7fcca9a6530a69f79f973541239.jpg/v1/fill/w_720,h_480,al_c,q_80,enc_avif,quality_auto/56d501_c0fdf7fcca9a6530a69f79f973541239.jpg" },
    { id:2, url:"https://static.wixstatic.com/media/56d501_378913f060d3e8387992c98c7115d3b5.jpg/v1/fill/w_720,h_546,al_c,q_85,enc_avif,quality_auto/56d501_378913f060d3e8387992c98c7115d3b5.jpg" },
    { id:3, url:"https://static.wixstatic.com/media/56d501_b53942bc5729531c070954c27efcaf45.jpg/v1/fill/w_720,h_480,al_c,q_80,enc_avif,quality_auto/56d501_b53942bc5729531c070954c27efcaf45.jpg" },
    { id:4, url:"https://static.wixstatic.com/media/56d501_677da8b38d6f4564d3860eb72434c372.png/v1/fill/w_980,h_281,al_c,q_85,usm_0.66_1.00_0.01,enc_avif,quality_auto/56d501_677da8b38d6f4564d3860eb72434c372.png" },
    { id:5, url:"https://static.wixstatic.com/media/56d501_0fe75217e89749d1103bde6b9b1e7cd8.jpg/v1/fill/w_980,h_367,al_c,q_80,usm_0.66_1.00_0.01,enc_avif,quality_auto/56d501_0fe75217e89749d1103bde6b9b1e7cd8.jpg" },
    { id:6, url:"https://static.wixstatic.com/media/56d501_a223525ad4cae2c658eede0fc7d5e874.jpg/v1/fill/w_980,h_653,al_c,q_85,usm_0.66_1.00_0.01,enc_avif,quality_auto/56d501_a223525ad4cae2c658eede0fc7d5e874.jpg" },
    { id:7, url:"https://static.wixstatic.com/media/56d501_d14afc45470e60ef69a4baa21f49df35.jpg/v1/fill/w_980,h_991,al_c,q_85,usm_0.66_1.00_0.01,enc_avif,quality_auto/56d501_d14afc45470e60ef69a4baa21f49df35.jpg" },
    { id:8, url:"https://static.wixstatic.com/media/56d501_2971f86a1e260dd813a79ce27bbfa6af.jpg/v1/fill/w_410,h_270,al_c,q_80,usm_0.66_1.00_0.01,enc_avif,quality_auto/56d501_2971f86a1e260dd813a79ce27bbfa6af.jpg" },
  ],
  featured: [
  ...
  contact: { email:"sunnysawrav@gmail.com", phone:"+91-7892378521", linkedin:"https://www.linkedin.com/in/sunnysawrav/", instagram:"https://www.instagram.com/sunnysawrav/", facebook:"http://www.facebook.com/sunnysawrav", twitter:"http://www.twitter.com/helldoom" },
};
        ...
        <section id="about" className="sec alt">
          <div className="inn">
            ...
            <div className="about-wrap">
              ...
              <p className="apersonal">{data.about.personal}</p>
            </div>
          </div>
        </section>
            ...
            <div className="gal-grid">
              {data.gallery.map(g=>(
                <div key={g.id} className="gal-item">
                  <img src={g.url} alt={`Gallery ${g.id}`} onError={e=>{e.target.parentElement.style.background="linear-gradient(135deg,#1a1a1a,#2a1a1a)";e.target.style.display="none";}}/>
                </div>
              ))}
            </div>
          </div>
        ...
        <section id="random" className="sec">
          <div className="inn">
            ...
            <div className="gs-intro">
              ...
              <p className="gs-desc">When I'm not behind the scenes or in the edit suite, I'm gaming. Here's a peek at the other side of Sunny.</p>
            </div>
          ...
          <div className="inn">
            ...
            <div className="cw">
              ...
              <div className="cl">
                ...
                <div className="ci"><FbIco/><a href={data.contact.facebook} target="_blank" rel="noopener noreferrer">Facebook</a></div>
                <div className="ci"><TwIco/><a href={data.contact.twitter} target="_blank" rel="noopener noreferrer">Twitter</a></div>
              </div>
            </div>
          </div>
        </section>
