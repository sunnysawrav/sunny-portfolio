...
const data = {
  ...
  gallery: [
    { id:1, url:"https://static.wixstatic.com/media/56d501_c0fdf7fcca9a6530a69f79f973541239.jpg" },
    { id:2, url:"https://static.wixstatic.com/media/56d501_378913f060d3e8387992c98c7115d3b5.jpg" },
    { id:3, url:"https://static.wixstatic.com/media/56d501_b53942bc5729531c070954c27efcaf45.jpg" },
    { id:4, url:"https://static.wixstatic.com/media/56d501_677da8b38d6f4564d3860eb72434c372.png" },
    { id:5, url:"https://static.wixstatic.com/media/56d501_0fe75217e89749d1103bde6b9b1e7cd8.jpg" },
    { id:6, url:"https://static.wixstatic.com/media/56d501_a223525ad4cae2c658eede0fc7d5e874.jpg" },
    { id:7, url:"https://static.wixstatic.com/media/56d501_d14afc45470e60ef69a4baa21f49df35.jpg" },
    { id:8, url:"https://static.wixstatic.com/media/56d501_2971f86a1e260dd813a79ce27bbfa6af.jpg" },
  ],
  featured: [
        ...
        <section id="gallery" className="sec alt">
          <div className="inn">
            ...
            <div className="gal-grid">
              {data.gallery.map(g=>(
                <div key={g.id} className="gal-item" onClick={()=>setLightbox(g.url)}>
